...
export class ListComponent {
  ...
  delete(i:number){this.employees.splice(i,1);}
  packagehtl(){this.employees.sort((a:any,b:any)=>b.package-a.package);}
  ...
  bonus(){this.employees=this.employees.map((employee:any)=>{employee.package=employee.package+30000;
    return employee;
  })}
